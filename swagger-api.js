...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    servers: [
      {
        url: "http://localhost:8080", // 应与 server.js 中的 PORT 一致
      },
    ],
    components: {
      // 新增: 定义安全方案
      ...
      schemas: {
        ...
        AuthorInfo: {
          // Reusable schema for author details
          type: "object",
          properties: {
        ...
        RelatedArticleInfo: {
          // Reusable for related article snippet
          type: "object",
          properties: {
        ...
        ExperienceComment: {
          // Based on models/experienceComment.model.js
          type: "object",
          properties: {
        ...
        AuditLogEntry: {
          // Based on models/auditLog.model.js
          type: "object",
          properties: {
        ...
        AdminUserListItem: {
          // For combined User and Staff list
          type: "object",
          properties: {
            // Common fields first
        ...
        StaffCreationPayloadByAdmin: {
          // Similar to StaffRegistrationPayload, but admin might not need confirmPassword
          type: "object",
        ...
        NotificationRelatedData: {
          // A flexible schema for related data
          type: "object",
        ...
        BriefArticleInfo: {
          // For embedding in TagWithArticles
          type: "object",
          properties: {
            articleID: { type: "string", format: "uuid" },
            title: { type: "string" },
        ...
        TagResponse: {
          // Common response for create/update
          type: "object",
          properties: {
            message: { type: "string" },
        ...
        KnowledgeArticleDetailed: {
          ...
          properties: {
            ...
            parentArticle: {
              // Snippet of parent article, if any
              type: "object",
              nullable: true,
              properties: {
                articleID: { type: "string", format: "uuid" },
        ...
        ArticleFeedback: {
          // Based on models/articleFeedback.model.js
          type: "object",
          properties: {
        ...
        ArticleVersion: {
          // Based on models/articleVersion.model.js
          type: "object",
          properties: {
        ...
        KnowledgeArticleCreatePayload: {
          ...
          properties: {
            ...
            status: {
              type: "string",
              enum: ["Draft", "PendingReview", "Published"],
              default: "Draft",
              description: "文章状态",
            },
            parentArticleID: {
        ...
        MedicalCategory: {
          ...
          properties: {
            ...
            }, // Assuming this is populated
            createdAt: { type: "string", format: "date-time" },
            updatedAt: { type: "string", format: "date-time" },
            subcategories: {
              // For GET /:categoryId response
              type: "array",
